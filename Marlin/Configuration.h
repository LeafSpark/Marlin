...
#define STRING_CONFIG_H_AUTHOR "SillyTom" // Who made the changes.
...
#define CLASSIC_JERK
  ...
  #define TRAVEL_EXTRA_XYJERK 0.5     // Additional jerk allowance for all travel moves
...
/**
 * The CRTouch probe uses a optical sensor and emulates a servo.
 */
#define CRTOUCH
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.00, -13.00, 0 }
...
#define Z_PROBE_FEEDRATE_FAST (3250)
...
#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP 125   // (°C) Only applies to E0 at this time
...
// Clarity to CRTouch users
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.12  // (mm) Default layer height for the G26 Mesh Validation Tool.
...
// #define PREHEAT_7_LABEL       "PVB"
// #define PREHEAT_7_TEMP_HOTEND 220
// #define PREHEAT_7_TEMP_BED     75
// #define PREHEAT_7_FAN_SPEED   255
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_TRIANGLES  0

  // Specify positions for each tool as { { X, Y, Z }, { X, Y, Z } }
  // Dual hotend system may use { {  -20, (Y_BED_SIZE / 2), (Z_MIN_POS + 1) },  {  420, (Y_BED_SIZE / 2), (Z_MIN_POS + 1) }}
  #define NOZZLE_CLEAN_START_POINT { {  235, 220, (Z_MIN_POS + 3) } }
  #define NOZZLE_CLEAN_END_POINT   { { 220, 220, (Z_MIN_POS + 3) } }
  ...
  #define WIPE_SEQUENCE_COMMANDS "G0 F7800\nG0 Z10 X0\nG0 Y2\nG0 F5000 X223\nG0 F6000 X220\nG0 Z5\nG28XY"
