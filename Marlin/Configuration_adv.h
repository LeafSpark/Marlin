...
//#define EXTRUDER_RUNOUT_PREVENT
  ...
  #define EXTRUDER_RUNOUT_MINTEMP 250
  #define EXTRUDER_RUNOUT_SECONDS 200
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  35, 35 }, { 170,  20 }, { 170, 180 }, { 20, 180 } }
...
#define G29_RETRY_AND_RECOVER
   ...
   */
  #define G29_SUCCESS_COMMANDS "M117 Auto Bed Leveling done."
  #define G29_RECOVER_COMMANDS "M117 Probe failed. Releveling.\nG28\nM300"
...
//
#define SAVED_POSITIONS 5         // Each saved position slot costs 12 bytes (833 is around 10k bytes)
 ...
 */
#define STARTUP_COMMANDS "M117 Have a great day!"
...
//#define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_TITLE "GCode Commands"
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "Script Completed"
  //#define CUSTOM_MENU_CONFIG_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_CONFIG_SCRIPT_RETURN  // Return to status screen after a script
  #define CUSTOM_MENU_CONFIG_ONLY_IDLE        // Only show custom menu when the machine is idle

  #define CONFIG_MENU_ITEM_1_DESC "Emergency Stop"
  #define CONFIG_MENU_ITEM_1_GCODE "M112"
 #define CONFIG_MENU_ITEM_1_CONFIRM        // Show a confirmation dialog before this action

  #define CONFIG_MENU_ITEM_2_DESC "Retract"
  #define CONFIG_MENU_ITEM_2_GCODE "G10"
  //#define CONFIG_MENU_ITEM_2_CONFIRM

  #define CONFIG_MENU_ITEM_3_DESC "Mesh Validation (G26)"
